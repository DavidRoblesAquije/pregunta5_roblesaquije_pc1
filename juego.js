...
var Juego = {
	preload: function () {
		...
		juego.load.image('malo', 'img/ovni.png');
	...
	crearEnemigo: function () {
		...
		enem.anchor.setTo(0.2); //velocidad de aparicion
